...
export default function Webhooks() {
  ...
  // Code snippets (same as before - keeping them short for brevity)
...
?>`;
  ...
  return (
    <>
            ...
            <div className="glow-card p-0 rounded-2xl overflow-hidden border border-white/5 bg-[#080808]">
              <div className="flex bg-white/[0.02] border-b border-white/5 items-center px-4 py-3">
                <div className="flex items-center gap-2 text-yellow-500 min-w-0">
                  ...
                  <span className="text-[10px] uppercase font-black tracking-widest truncate">Webhook Payload</span>
                </div>
                <div className="flex-1" />
                <button 
      ...
      {/* Floating WhatsApp Support Button - Bottom Right (Thoda upar) */}
      <motion.button
        onClick={handleWhatsAppSupport}
        onMouseEnter={() => setIsHovered(true)}
        onMouseLeave={() => setIsHovered(false)}
        className="fixed bottom-24 right-6 z-50 flex flex-col items-center justify-center group"
      ...
      >
        {/* Glow Effect */}
        <div className="absolute inset-0 bg-[#25D366] rounded-full blur-xl opacity-50 group-hover:opacity-70 transition-opacity duration-300" />
        
        {/* WhatsApp Icon Container */}
        <div className="relative w-14 h-14 rounded-full bg-[#25D366] shadow-lg shadow-[#25D366]/30 flex items-center justify-center transition-all duration-300 group-hover:shadow-xl group-hover:shadow-[#25D366]/40">
          <img 
